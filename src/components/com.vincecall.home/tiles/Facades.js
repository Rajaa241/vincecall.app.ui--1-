...
import { MANAGE_EXAMS, MANAGE_TENANTS, MANAGE_USERS, PRACTICE_EXAMS, EXAM_TYPE_PRACTICE, EXAM_TYPE_ASSIGNED, ASSIGNED_EXAMS, EXAM_TYPE_ALL, EXAM_REPORT, REPORTS, CONTENT_CREATION, ANALYTICS, OVERALL_ANALYTICS, ALL_REPORTS } from '../constants/constants';
